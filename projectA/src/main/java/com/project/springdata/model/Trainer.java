 ...
 */
package com.project.springdata.model;
...
@NamedQueries({
    ...
    @NamedQuery(name = "Trainer.findByCourse", query = "SELECT t FROM Trainer t WHERE t.course = :course")})
public class Trainer implements Serializable {
    ...
    public Trainer(Integer id, String firstname, String lastname, String course) {
        this.id = id;
